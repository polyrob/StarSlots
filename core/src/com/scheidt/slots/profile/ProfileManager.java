...
public class ProfileManager
{
    ...
    public Profile retrieveProfile()
    {
        ...
        Gdx.app.log( this.getClass().getSimpleName(), "Retrieving profile from: " + profileDataFile.path() );
        ...
        if( profileDataFile.exists() ) {
            ...
            try {
                ...
                if( profileAsText.matches( "^[A-Za-z0-9/+=]+$" ) ) {
                    Gdx.app.log( this.getClass().getSimpleName(), "Persisted profile is base64 encoded" );
                ...
                // log the exception
                Gdx.app.error( this.getClass().getSimpleName(), "Unable to parse existing profile data file", e );
        ...
        Profile profile )
    {
        // create the handle for the profile data file
        FileHandle profileDataFile = Gdx.files.local( PROFILE_DATA_FILE );
        Gdx.app.log( this.getClass().getSimpleName(), "Persisting profile in: " + profileDataFile.path() );
